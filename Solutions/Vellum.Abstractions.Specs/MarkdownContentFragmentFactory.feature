...
Scenario: Converting a Markdown Document into a ContentFragment
  ...
  Then Content Fragment should contain
    ...
    | application/vnd.vellum.content.blogs+md | 2020-07-15 06:30:00 | a8297eeb1841adf4d4f71efe2d7a43f5cba3a357eda570feeb02f5527619a130 | Blogs | 0        | Published         | How serverless is replacing the data warehouse |
