Feature: MarkdownContentFragmentFactory
...
Scenario: Converting a Markdown Document into a ContentFragment
  ...
  Then Content Fragment should contain
    ...
    | application/vnd.vellum.content.blogs+md | 7/15/2020 6:30:00 AM | 4563a46c876e45092f0436fb6a3363fe7af78fde38d8e0827af21cd6473511f4 | Blogs | 0        | Published         | How serverless is replacing the data warehouse |
